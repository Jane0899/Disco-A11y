...
public static class Strings
{
    ...
    private static readonly Dictionary<string, (string En, string De)> Table = new()
    {
        ...
        ["TestVoice"] = ("Test voice", "Stimme testen"),
        ["VoiceSample"] = ("This is the orb voice. Does it read clearly?", "Dies ist die Orb-Stimme. Liest sie gut vor?"),
        ["StatusTestingVoice"] = ("Playing a sample with the selected voice...", "Spiele eine Probe mit der gewählten Stimme..."),
        ["StatusTestVoiceUnavailable"] = ("Could not play - is the mod (with its TTS server) installed in this game folder?", "Konnte nicht abspielen - ist der Mod (mit TTS-Server) in diesem Spielordner installiert?"),
        ["StatusTestVoiceError"] = ("Voice test failed: {0}", "Stimmentest fehlgeschlagen: {0}"),
