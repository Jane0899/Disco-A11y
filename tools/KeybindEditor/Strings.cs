...
public static class Strings
{
    ...
    private static readonly Dictionary<string, (string En, string De)> Table = new()
    {
        ...
        ["PresetSafe"] = ("Load preset: Layout-safe", "Preset: Layoutsicher laden"),
        ...
        ["StatusPressKey"] = ("Now press the desired key (optionally with Ctrl/Alt/Shift). Escape cancels.", "Bitte jetzt die gewünschte Taste (optional mit Strg/Alt/Umschalt) drücken. Escape bricht ab."),
        ...
        ["StatusSafePreset"] = ("Layout-safe preset loaded (numpad + stardew-access-style navigation keys; works regardless of keyboard layout). Don't forget to save.", "Layoutsicheres Preset geladen (Ziffernblock + Navigationstasten im Stil von stardew-access; funktioniert unabhängig vom Tastaturlayout). Nicht vergessen zu speichern."),
